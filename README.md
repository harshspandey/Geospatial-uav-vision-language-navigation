...
## PART 1 — Replicating on Our Lab Server (priyanka@172.27.21.66)

All data, code, dependencies, and model weights are already set up on this server.
...
- Working directory: /home/priyanka/GROUP_1_DLCV/Flight_GPT/FlightGPT_GeoPrior/

### Step 1 — Connect to Server

ssh priyanka@172.27.21.66
...
IMPORTANT: GPU must be completely free. Kill any running processes first:
...
Problem                          | Solution
---------------------------------|--------------------------------------------------
OOM error during SFT or GRPO    | Kill all GPU processes first:
...
ModuleNotFoundError              | conda activate dlcv_vghpm
FlashAttention-2 not installed   | Normal warning — falls back to torch SDPA, no impact on results
SFT drops all samples            | Check dataset_info.json has system_tag entry for geo dataset
