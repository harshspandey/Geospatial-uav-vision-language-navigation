...
def parse_args():
    ...
    parser.add_argument('--gsam_use_segmentation_mask', action='store_true', default=True)
    ...
    parser.add_argument('--gsam_box_threshold', type=float, default=0.2)
    ...
    parser.add_argument('--checkpoint', type=str, default='/mnt/vepfs/fs_users/Djinhan/LLN/ckpt/mgp_mturk.pth')
